{
    ...
    \vspace{1em}
    \textbf{\lineunderscorec[Савко Олега Александровича]} \\
    {\small (фамилия, имя, отчество) }

    \end{center}

    1. Тема проекта (работы):
    \lineunderscore[Информационно-аналитическое программное средство взаимодействия клиента с сайтом]\\
    \lineunderscore\\
    ...
    \lineunderscore[Тип операционной системы~-- Linux; Языки программирования~-- Java, Перечень выполняемых функций: а) интеграция с Salesforce Online Chat; б) интеграция с FullContact; в) создание системы отслеживающей события; Назначение разработки: создание программного средства предоставляющие сбор статистики действий пользователя на сайте и интеграцию с CRM системами]

    \vspace{1em}

    4. Содержание пояснительной записки (перечень подлежащих разработке вопросов):
    \lineunderscore[Введение]\\
    \lineunderscore[1 Аналитический обзор существующих решений]\\
    \lineunderscore[2 Модели, положенные в основу разрабатываемого программного средства]\\
    ...
    \lineunderscore[6 Руководство пользователя]\\
    \lineunderscore[7 Технико-экономическое обоснование эффективности разработки и использования
    ...
    \lineunderscore[Функциональная модель. Плакат - формат А1, лист 1.]\\
    \lineunderscore[Диаграмма взаимодействия микросервисов. Плакат - формат А1, лист 1.]\\
    \lineunderscore[Скриншоты программного средства. Плакат - формат А1, лист 1.]\\
    \lineunderscore[Интеграция с Salesforce Online Chat. Схема программы - формат А1, лист 1.]\\
    \lineunderscore[Классификация события. Схема алгоритма - формат А1, лист 1.]\\
    \lineunderscore[Сохранение события. Схема алгоритма - формат А1, лист 1.]\\
    \lineunderscore
    ...
    Дата выдачи задания \lineunderscorec[~~1 февраля 2016~~] \hspace{2ex} Руководитель \hfill{} \uline{\hspace*{4em}} / О.\,А.~Мацкевич /

    \vspace{1em}

    Задание принял к исполнению  \uline{\hspace*{4em}} / О.\,А.~Савко /
